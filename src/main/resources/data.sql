...
INSERT INTO WORKOUT (ID, ROOM_NUMBER, CAPACITY, PARTICIPANTS_NUMBER, WORKOUT_NAME, WORKOUT_START_DATE, WORKOUT_END_DATE, TRAINER_USERNAME, WORKOUT_DIFFICULTY)
VALUES (NEXTVAL('WORKOUT_SEQ'), 103, 30, 0, 'KLATKA', NOW()::date + INTERVAL '1 day' + INTERVAL '10 hour', NOW()::date + INTERVAL '1 day' + INTERVAL '10 hour' + INTERVAL '45 minutes', 'igor_gym', 1);
...
INSERT INTO WORKOUT (ID, ROOM_NUMBER, CAPACITY, PARTICIPANTS_NUMBER, WORKOUT_NAME, WORKOUT_START_DATE, WORKOUT_END_DATE, TRAINER_USERNAME, WORKOUT_DIFFICULTY)
VALUES (NEXTVAL('WORKOUT_SEQ'), 105, 30, 0, 'BRZUCH', NOW()::date + INTERVAL '2 day' + INTERVAL '13 hour', NOW()::date + INTERVAL '2 day' + INTERVAL '13 hour' + INTERVAL '45 minutes', 'igor_gym', 1);
----------------
...
INSERT INTO WORKOUT (ID, ROOM_NUMBER, CAPACITY, PARTICIPANTS_NUMBER, WORKOUT_NAME, WORKOUT_START_DATE, WORKOUT_END_DATE, TRAINER_USERNAME, WORKOUT_DIFFICULTY)
VALUES (NEXTVAL('WORKOUT_SEQ'), 102, 30, 0, 'PLECY', NOW()::date + INTERVAL '3 day' + INTERVAL '9 hour', NOW()::date + INTERVAL '3 day' + INTERVAL '9 hour' + INTERVAL '45 minutes', 'igor_gym', 1);
